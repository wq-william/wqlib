...
import hz.wq.common.util.other.AppAdapter
import hz.wq.common.util.other.BaseAdapter
            ...
            when (view.id) {
                R.id.tv_ui_confirm -> {
                    ...
                    if (data.size >= adapter.getMinSelect()) {
                        ...
                        ToastUtils.showShort(String.format(getString(R.string.select_min_hint)!!, adapter.getMinSelect()))
                    }
                }
                R.id.tv_ui_cancel -> {
                    autoDismiss()
        ...
        override fun onItemClick(recyclerView: RecyclerView?, itemView: View?, position: Int) {
            if (selectSet.containsKey(position)) {
                ...
                if (selectSet.size < maxSelect) {
                    ...
                    ToastUtils.showShort(String.format(getString(R.string.select_max_hint)!!, maxSelect))
                }
            }
        }
