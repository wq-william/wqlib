...
import hz.wq.common.util.other.CheckNet
import hz.wq.common.util.other.Permissions
...
//        @Permissions(Permission.REQUEST_INSTALL_PACKAGES)
        ...
        private fun getInstallIntent(): Intent {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                uri = FileProvider.getUriForFile(getContext(), AppUtils.getAppPackageName() + ".provider", apkFile!!)
